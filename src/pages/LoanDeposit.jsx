...
function LoanDeposit() {
  ...
  useEffect(() => {
    const fetchLoanDocuments = async () => {
      try {
        const response = await fetch('https://firestore.googleapis.com/v1/projects/banking-8d939/databases/(default)/documents/Loan');
  ...
  const handleSubmitPayment = async (e) => {
    ...
    try {
      ...
      const accountResponse = await fetch('https://firestore.googleapis.com/v1/projects/banking-8d939/databases/(default)/documents/Account');
      ...
      await fetch('https://firestore.googleapis.com/v1/projects/banking-8d939/databases/(default)/documents/Transactions', {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json'
        },
