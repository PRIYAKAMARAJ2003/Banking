...
const deleteBankFromDatabase = (documentId) => {
  ...
  return (
    <>
    <div style={{background: 'linear-gradient(to bottom, #078a83, gray)',width: '450px',height:'100px', borderRadius: '10px',justifyContent:'center', alignItems:'center'}}>
      <h1 style={{color: 'black',justifyContent:'center', alignItems:'center'}}>Bank Registration</h1>
      <div style={{background: 'linear-gradient(to bottom, #078a83, gray)'}}>
        {/* <button onClick={handleAdd} style={{marginBottom: '20px', backgroundColor: '#283530'}}>Add</button> */}
        <button onClick={handleUpdate} style={{marginBottom: '20px', backgroundColor: '#283530'}}>Update</button>
        {/* <button onClick={handleDelete} style={{backgroundColor: '#283530'}}>Delete</button> */}
      </div>
